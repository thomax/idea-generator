    ...
    variants: [
      {
        ...
        alternatives: [
          ...
          'Kan oppfinnelsen bli tryggere å bruke?',
          'Er det noe som finnes i dag som oppfinnelsen kan kombineres med?',
          'Hva skjer hvis du gjør oppfinelsen større?',
          'Hva skjer hvis du gjør oppfinelsen mindre?',
          'Hvor får oppfinnelsen energi fra?',
          'Hva slags materialer er oppfinnelsen laget av?',
          'Hvordan virker den?',
          'Finnes det andre måter å løse problemet på?']
      },
      {
        label: 'Problem',
        alternatives: [
          ...
          'Genererer denne oppfinnelsen flere problemer?'
        ]
      },
      {
        label: 'Bruker',
        alternatives: [
          ...
          'Hvem skal bruke oppfinnelsen?',
          'Kan oppfinnelsen brukes av flere samtidig?'
        ]
      }
    ]
  },
